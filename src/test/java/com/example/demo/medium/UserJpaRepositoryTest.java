...
public class UserJpaRepositoryTest {
    ...
    void findsUserDataWithFindByEmailAndStatus(){
        ...
        //when
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("geon1120@gmail.com", UserStatus.ACTIVE);
    ...
    void returnsOptionalEmptyWhenThereIsNoUserData(){
        //given
        Optional<UserEntity> result = userJpaRepository.findByEmailAndStatus("geon1120@gmail.com", UserStatus.PENDING);
